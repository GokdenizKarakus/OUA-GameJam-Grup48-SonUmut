...
namespace UnityEngine.Rendering.UnifiedRayTracing
{
    internal class ComputeRayTracingShader : IRayTracingShader
    {
        ...
        public void SetAccelerationStructure(CommandBuffer cmd, string name, IRayTracingAccelStruct accelStruct)
        {
            ...
            cmd.SetComputeBufferParam(m_Shader, m_KernelIndex, name+"bvh", computeAccelStruct.accelStruct.topLevelBvh);
            cmd.SetComputeBufferParam(m_Shader, m_KernelIndex, name+"bottomBvhs", computeAccelStruct.accelStruct.bottomLevelBvhs);
            cmd.SetComputeBufferParam(m_Shader, m_KernelIndex, name+"instanceInfos", computeAccelStruct.accelStruct.instanceInfos);
        }
