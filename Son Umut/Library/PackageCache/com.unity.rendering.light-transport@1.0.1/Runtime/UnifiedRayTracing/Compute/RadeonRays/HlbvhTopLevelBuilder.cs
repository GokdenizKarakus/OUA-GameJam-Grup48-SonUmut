...
namespace UnityEngine.Rendering.RadeonRays
{
    ...
    internal class HlbvhTopLevelBuilder
    {
        ...
        public void AllocateResultBuffers(uint instanceCount, ref TopLevelAccelStruct accelStruct)
        {
            ...
            accelStruct.Dispose();
            accelStruct.instanceInfos = new GraphicsBuffer(RadeonRaysAPI.ComputeBufferTarget, (int)instanceCount, Marshal.SizeOf<InstanceInfo>());
            accelStruct.topLevelBvh = new GraphicsBuffer(RadeonRaysAPI.ComputeBufferTarget, (int)bvhNodeCount + 10, Marshal.SizeOf<BvhNode>()); // plus one for header
        }

        public void CreateEmpty(ref TopLevelAccelStruct accelStruct)
        {
            accelStruct.Dispose();
            accelStruct.topLevelBvh = new GraphicsBuffer(RadeonRaysAPI.ComputeBufferTarget, (int)2, Marshal.SizeOf<BvhNode>());
