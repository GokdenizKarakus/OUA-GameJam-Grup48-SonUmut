...
namespace UnityEngine.Rendering.UnifiedRayTracing
{
    ...
    internal class ComputeRayTracingAccelStruct : IRayTracingAccelStruct
    {
        ...
        public TopLevelAccelStruct accelStruct { get { return m_TopLevelAccelStruct.GetValueOrDefault(); } }
            ...
            ReferenceCounter counter, int blasBufferInitialSizeBytes = 64 * 1024 * 1024)
        {
            ...
            m_BlasBuffer = new GraphicsBuffer(RadeonRaysAPI.ComputeBufferTarget, blasNodeCount, RadeonRaysAPI.BvhNodeSizeInBytes());
        ...
        private BlockAllocator.Allocation AllocateBlas(int allocationNodeCount)
        {
            ...
            if (!allocation.valid)
            {
                ...
                var newBlasBuffer = new GraphicsBuffer(RadeonRaysAPI.ComputeBufferTarget, newBvhNodeCount, RadeonRaysAPI.BvhNodeSizeInBytes());
